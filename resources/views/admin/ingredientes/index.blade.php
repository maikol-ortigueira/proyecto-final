<x-app-layout>
  ...
  <div class="container m-auto mt-5">
    {{-- Botón para añadir nuevos ingredientes --}}
    <div class="my-6 text-right">
      <a href="{{ route('admin.ingredientes.create') }}"
        class="rounded bg-blue-500 py-1 px-2 capitalize text-blue-100 hover:bg-blue-800">{{ __('new ingredient') }}</a>
    </div>
