<x-app-layout>
  ...
  <div class="container m-auto mt-5">
    {{-- Botón para añadir nuevas recetas --}}
    <div class="my-6 text-right">
      <a href="{{ route('admin.recetas.create') }}"
        class="rounded bg-blue-500 py-1 px-2 capitalize text-blue-100 hover:bg-blue-800">{{ __('nueva') .' ' . __('recipe') }}</a>
    </div>
                ...
                @foreach ($recetas as $item)
                  <tr
                    ...
                    <td class="whitespace-nowrap py-4 px-6 text-right text-sm font-medium">
                      <a href="{{ route('admin.recetas.edit', ['receta' => $item]) }}"
