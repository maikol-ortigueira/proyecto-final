<x-app-layout>
  <x-slot name="header">
    <h2 class="text-xl font-semibold capitalize leading-tight text-gray-800">{{ __('nueva') . ' ' . __('tag') }}
    </h2>
  </x-slot>
  ...
  <div class="container m-auto py-6">
    {{-- Formulario --}}
    <form action="{{ route('admin.etiquetas.store') }}" id="etiquetaForm" method="post">
      @csrf
      @method('POST')
