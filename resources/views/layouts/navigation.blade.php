    ...
    <div class="flex h-16 justify-between">
      <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          <x-nav-link :href="route('admin.recetas.index')" :active="request()->routeIs('admin.recetas.index')">
            {{ __('Recipes') }}
          </x-nav-link>
          <x-nav-link :href="route('admin.ingredientes.index')"
            :active="request()->routeIs('admin.ingredientes.index')">
            {{ __('Ingredients') }}
          </x-nav-link>
          <x-nav-link :href="route('admin.categorias.index')" :active="request()->routeIs('admin.categorias.index')">
            {{ __('Categories') }}
          </x-nav-link>
          <x-nav-link :href="route('admin.etiquetas.index')" :active="request()->routeIs('admin.etiquetas.index')">
            {{ __('Tags') }}
          </x-nav-link>
          {{-- Solo un superadministrador tiene acceso a datos de usuarios --}}
